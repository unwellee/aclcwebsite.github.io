            ...
            <table class="table table-hover justify-content-center">
                <thead class="table table-default font-size-20">
                    <tr>
                        ...
                        <?php }else if($_SESSION['department'] == "TEACHER"){ ?>
                        <th>Edit / Delete</th>
                        <?php }?>
                    </tr>
                </thead>
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <?php if($_SESSION['department'] == "ADMIN"){ ?>
                                <td><a href="approvethisannouncement.php?id=<?php echo $row['id'];?>"><i class="fas fa-check m-2"></i></a><a onclick="return confirm('Are you sure you want to approve this product?')" href="delpendingannouncement.php?id=<?php echo $row['id'];?>"><i class="fas fa-trash-alt"></i></a></td>                        </tr>
                            <?php }else if($_SESSION['department'] == "TEACHER"){ ?>
