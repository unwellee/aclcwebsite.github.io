<?php
   ...
   if(isset($_POST['announcebtn'])){
        ...
        //query update
        $sql = "UPDATE `pendingrequest`
                SET `subject`= '$subject',`announcement`='$announcement',`img`='$image',`status`='$status',`dept`='$department'
                WHERE `id`='$id'";
   ...
   if (isset($_GET['id'])){
    ...
    $id = $_GET['id'];
    $rcd = "SELECT * FROM `pendingrequest` WHERE `id` = '$id'";
